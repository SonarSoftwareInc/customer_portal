...
class SonarCustomerPortalPolicy extends Basic
{
	public function configure()
	{
		parent::configure();
  		...
  		$this
			->addDirective(Directive::FRAME, Keyword::SELF, 'js.stripe.com')
			->addDirective(Directive::FRAME_ANCESTORS, Keyword::NONE)
			->addDirective(Directive::FORM_ACTION, Keyword::SELF, 'www.paypal.com')
			->addDirective(Directive::UPGRADE_INSECURE_REQUESTS, Value::NO_VALUE)
			->addDirective(Directive::SCRIPT, Keyword::SELF, 'js.stripe.com')
			->addDirective(Directive::CONNECT, Keyword::SELF, 'api.stripe.com')
			->addDirective(Directive::STYLE, Keyword::SELF, 'chartjs.org')
			->addNoneForDirective(Directive::STYLE)
