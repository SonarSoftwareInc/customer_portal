    ...
    public function boot(): void
    {
        ...
        try {
            ...
            config([
                ...
                'mail.smtp.host' => $systemSetting->mail_host,
                'mail.smtp.port' => $systemSetting->mail_port,
                'mail.smtp.username' => $systemSetting->mail_username,
                'mail.smtp.password' => $systemSetting->mail_password,
                'mail.smtp.encryption' => $systemSetting->mail_encryption ? 'tls' : null,
                'mail.from' => [
