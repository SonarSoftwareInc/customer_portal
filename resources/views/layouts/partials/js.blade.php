...
close=document.getElementById("close");close.addEventListener('click',function(){close.className.Add("csp_style3"); setTimeout(function(){ close.className,Add("csp_style1"); }, 600); },false);
   var _portal = {
