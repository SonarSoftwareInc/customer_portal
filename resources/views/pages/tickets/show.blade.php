...
<div class="card-body">
                        ...
                        <div class="comment-left mb-4">
                           <div class="comment-body">
                              <div class="row">
                                 <div class="col">
                                    <h5 class="comment-title">
                                       {{utrans("tickets.ispWrote",['companyName' => config("customer_portal.company_name")])}}
                                    </h5>
                                 </div>
                                 <div class="col-auto">
   ...
   <div class="card">
      <div class="card-body">
         {!! Form::open(['action' => ['\App\Http\Controllers\TicketController@postReply', 'tickets' => $ticket->getTicketID()], 'id' => 'replyForm', 'method' => 'post']) !!}
